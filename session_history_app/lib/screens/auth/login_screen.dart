...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (success) {
      Navigator.of(
        context,
      ).pushAndRemoveUntil(AppRoute(const MainNavigation()), (route) => false);
    } else if (auth.pendingVerificationEmail != null) {
      // Compte existant mais email jamais vérifié : on l'envoie vérifier son code.
      Navigator.of(context).push(AppRoute(const VerifyEmailScreen()));
    } else {
                      ...
                      Align(
                        ...
                        child: TextButton(
                          onPressed: () => Navigator.of(
                            context,
                          ).push(AppRoute(const ForgotPasswordScreen())),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => Navigator.of(
                              context,
                            ).pushReplacement(AppRoute(const RegisterScreen())),
                            child: const Text(
                              'Register',
                              style: TextStyle(
                                color: AppColors.primary,
